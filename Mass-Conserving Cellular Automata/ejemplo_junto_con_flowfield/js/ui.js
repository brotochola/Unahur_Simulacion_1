...
function updateInspectorUI() {
  ...
  document.getElementById("inspPos").textContent =
    `X: ${mouseX} | Y: ${mouseY}`;
  ...
  document.getElementById("inspVec").textContent =
...
function setupUI() {
  ...
  document.getElementById("chkFlowfield").onchange = (e) => {
    flags.showFlowfield = e.target.checked;
  };
  document.getElementById("chkGrid").onchange = (e) => {
    flags.showGrid = e.target.checked;
  };
  document.getElementById("chkChunks").onchange = (e) => {
    flags.showChunks = e.target.checked;
  };
  ...
  const applyWorldSize = () => {
    ...
    n = Math.max(32, Math.min(1024, n | 0));
    reallocateGrid(n);
  };
  ...
  bindKnob("knobRestCapacity", "valRestCapacity", (v) => {
    cfg.restCapacity = v;
  });
  bindKnob("knobDiffusion", "valDiffusion", (v) => {
    cfg.diffusion = v;
  });
  bindKnob("knobGravity", "valGravity", (v) => {
    cfg.gravity = v;
  });
  bindKnob("knobLerp", "valLerp", (v) => {
    cfg.lerp = v;
  });
  bindKnob("knobFlowInfluence", "valFlowInfluence", (v) => {
    cfg.flowInfluence = v;
  });
  bindKnob(
    "knobMinFlow",
  ...
  bindKnob("knobFlowMaxMag", "valFlowMaxMag", (v) => {
    cfg.flowMaxMag = v;
  });
  bindKnob(
    "knobFlowAvgEvery",
    "valFlowAvgEvery",
    (v) => {
      cfg.flowAvgEvery = v | 0;
    },
    (v) => String(v | 0),
  );
  bindKnob("knobFlowAvgBlend", "valFlowAvgBlend", (v) => {
    cfg.flowAvgBlend = v;
  });
  bindKnob(
    "knobSubsteps",
  ...
  bindKnob("knobBrushAmount", "valBrushAmount", (v) => {
    cfg.brushAmount = v;
  });
  bindKnob("knobFlowDebugScale", "valFlowDebugScale", (v) => {
    cfg.flowDebugScale = v;
  });
  bindKnob("knobVelColorScale", "valVelColorScale", (v) => {
    cfg.velColorScale = v;
  });
  bindKnob("knobPressureRedAt", "valPressureRedAt", (v) => {
    cfg.pressureRedAt = v;
  });
  bindKnob("knobFoamVelScale", "valFoamVelScale", (v) => {
    cfg.foamVelScale = v;
  });
  bindKnob("knobNbMassRef", "valNbMassRef", (v) => {
    cfg.nbMassRef = v;
  });
  bindKnob("knobNbFoamThresh", "valNbFoamThresh", (v) => {
    cfg.nbFoamThresh = v;
  });
  bindKnob("knobNbVelWhite", "valNbVelWhite", (v) => {
    cfg.nbVelWhite = v;
  });
  bindKnob("knobDisplayLerp", "valDisplayLerp", (v) => {
    cfg.displayLerp = v;
  });
  bindKnob(
    "knobArrowStep",
